...
|SSD300-BN|Filter pruning, 40%, geometric median criterion|VOC2012 test|91.99|examples/object_detection/configs/ssd300_vgg_voc_pruning_geometric_median.json|[Link](https://storage.openvinotoolkit.org/repositories/nncf/models/v1.5.0/ssd300_vgg_voc_pruning_geometric_median.pth)|

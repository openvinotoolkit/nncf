...
|Inception V3|INT8 (per-tensor, symm. W, asymm. half-range A)|ImageNet|78.38 (-0.47)|[inception_v3_imagenet_int8.json](configs/quantization/inception_v3_imagenet_int8.json)|[Link](https://storage.openvinotoolkit.org/repositories/nncf/models/develop/inception_v3_imagenet_int8)|
|Inception V3|INT8 (per-tensor, symm. W, asymm. half-range A), Sparsity 61% (RB)|ImageNet|77.53 (0.38)|[inception_v3_imagenet_rb_sparsity_int8.json](configs/sparsity_quantization/inception_v3_imagenet_rb_sparsity_int8.json)|[Link](https://storage.openvinotoolkit.org/repositories/nncf/models/develop/inception_v3_imagenet_rb_sparsity_int8)|
|Inception V3|Sparsity 54% (Magnitude)|ImageNet|77.86 (0.05)|[inception_v3_imagenet_magnitude_sparsity.json](configs/sparsity/inception_v3_imagenet_magnitude_sparsity.json)|[Link](https://storage.openvinotoolkit.org/repositories/nncf/models/develop/inception_v3_imagenet_magnitude_sparsity)|
|MobileNet V2|None|ImageNet|71.85|[mobilenet_v2_imagenet.json](configs/classification/mobilenet_v2_imagenet.json)|-|
|MobileNet V2|INT8 (per-tensor, symm. W, asymm. half-range A)|ImageNet|71.63 (0.22)|[mobilenet_v2_imagenet_int8.json](configs/quantization/mobilenet_v2_imagenet_int8.json)|[Link](https://storage.openvinotoolkit.org/repositories/nncf/models/develop/mobilenet_v2_imagenet_int8)|
|MobileNet V2|INT8 (per-tensor, symm. W, half-range asymm. A), Sparsity 52% (RB)|ImageNet|70.96 (0.89)|[mobilenet_v2_imagenet_rb_sparsity_int8.json](configs/sparsity_quantization/mobilenet_v2_imagenet_rb_sparsity_int8.json)|[Link](https://storage.openvinotoolkit.org/repositories/nncf/models/develop/mobilenet_v2_imagenet_rb_sparsity_int8)|
|MobileNet V2| Sparsity 50% (RB)|ImageNet|71.33 (0.52)|[mobilenet_v2_imagenet_rb_sparsity.json](configs/sparsity/mobilenet_v2_imagenet_rb_sparsity.json)|[Link](https://storage.openvinotoolkit.org/repositories/nncf/models/develop/mobilenet_v2_imagenet_rb_sparsity)|
...
|MobileNet V3 (Small)|INT8 (per-channel symm. W, per-tensor half-range asymm. A)|ImageNet|67.79 (0.59)|[mobilenet_v3_small_imagenet_int8.json](configs/quantization/mobilenet_v3_small_imagenet_int8.json)|[Link](https://storage.openvinotoolkit.org/repositories/nncf/models/develop/mobilenet_v3_small_imagenet_int8)|
...
|MobileNet V3 (Large)|INT8 (per-channel symm. W, per-tensor asymm. half-range A)|ImageNet|75.04 (0.76)|[mobilenet_v3_large_imagenet_int8.json](configs/quantization/mobilenet_v3_large_imagenet_int8.json)|[Link](https://storage.openvinotoolkit.org/repositories/nncf/models/develop/mobilenet_v3_large_imagenet_int8)|
...
|ResNet-50|INT8 (per-tensor, symm. W, half-range asymm. A) + Sparsity 65% (RB)|ImageNet|74.32 (0.73)|[resnet50_imagenet_rb_sparsity_int8.json](configs/sparsity_quantization/resnet50_imagenet_rb_sparsity_int8.json)|[Link](https://storage.openvinotoolkit.org/repositories/nncf/models/develop/resnet50_imagenet_rb_sparsity_int8)|
|ResNet-50|Sparsity 80% (RB)|ImageNet|74.38 (0.67)|[resnet50_imagenet_rb_sparsity.json](configs/sparsity/resnet50_imagenet_rb_sparsity.json)|[Link](https://storage.openvinotoolkit.org/repositories/nncf/models/develop/resnet50_imagenet_rb_sparsity)|
...
|ResNet-50|Filter pruning, 40%, geometric median criterion|ImageNet|74.97 (0.08)|[resnet50_imagenet_pruning_geometric_median.json](configs/pruning/resnet50_imagenet_pruning_geometric_median.json)|[Link](https://storage.openvinotoolkit.org/repositories/nncf/models/develop/resnet50_imagenet_pruning_geometric_median)|
|ResNet-50|INT8 (symm. half-range W, asymm. A) + Filter pruning, 40%, geometric median criterion|ImageNet|75.00 (0.05)|[resnet50_imagenet_pruning_geometric_median_int8.json](configs/pruning_quantization/resnet50_imagenet_pruning_geometric_median_int8.json)|[Link](https://storage.openvinotoolkit.org/repositories/nncf/models/develop/resnet50_imagenet_pruning_geometric_median_int8)|

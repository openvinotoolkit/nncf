...
class SSDAugmentation:
    def __init__(self, size: int, mean: int, std: int, normalize_coef: int):
        self.size = size
        self.mean = mean
        self.std = std
        self.normalize_coef = normalize_coef

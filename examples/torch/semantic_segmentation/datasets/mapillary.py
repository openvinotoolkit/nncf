    ...
    def __init__(self, root, image_set="train", transforms=None, loader=data_utils.pil_loader):
        ...
        if self.mode.lower() == "train":
            ...
            self.train_labels = data_utils.get_files(
                os.path.join(self.root_dir, self.train_lbl_folder), extension_filter=self.label_extension
            )
            ...
            self.val_labels = data_utils.get_files(
                os.path.join(self.root_dir, self.val_lbl_folder), extension_filter=self.label_extension
            )

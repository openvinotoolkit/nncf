...
|MobileNet V2|INT8 w:sym,per-tensor a:sym,per-tensor |ImageNet|71.81|examples/tensorflow/classification/configs/quantization/mobilenet_v2_imagenet_int8.json|-|
...
|TensorFlow Hub MobileNet V2|Sparsity 35% (Magnitude)|ImageNet|71.73|examples/tensorflow/classification/configs/sparsity/mobilenet_v2_hub_magnitude_sparsity.json|[Link](https://storage.openvinotoolkit.org/repositories/nncf/tensorflow/models/develop/mobilenet_v2_hub_sparsity_35.tar.gz)|

...
install-onnx-test:
	...
	pip install "git+https://github.com/openvinotoolkit/open_model_zoo.git@37f60eb#egg=accuracy_checker&subdirectory=tools/accuracy_checker" # E2E test uses AC for models validation

...
class NonShapeModel(ONNXReferenceModel):
    ...
    def __init__(self):
        ...
        gather1_indices_initializer_tensor = create_initializer_tensor(
            name=gather1_indices_tensor_name,
            tensor_array=np.int64(0),
            data_type=onnx.TensorProto.INT64)
        ...
        gather2_indices_initializer_tensor = create_initializer_tensor(
            name=gather2_indices_tensor_name,
            tensor_array=np.int64(1),
            data_type=onnx.TensorProto.INT64)
        ...
        unsqueeze1_axes_initializer_tensor = create_initializer_tensor(
            name=unsqueeze1_axes_tensor_name,
            tensor_array=np.int64([0]),
            data_type=onnx.TensorProto.INT64)
        ...
        unsqueeze2_axes_initializer_tensor = create_initializer_tensor(
            name=unsqueeze2_axes_tensor_name,
            tensor_array=np.int64([0]),
            data_type=onnx.TensorProto.INT64)
        ...
        gemm_node = onnx.helper.make_node(
            name="Gemm",
            op_type="Gemm",
            inputs=[reshape_output_node_name, "W"],
            outputs=[gemm_output_node_name]
        )
        ...
        graph_def = onnx.helper.make_graph(
            nodes=[conv1_node, relu1_node,
                   ...
                   gather1_node, gather2_node,
                   unsqueeze1_node, unsqueeze2_node,
                   concat_node, avg_pool_node,

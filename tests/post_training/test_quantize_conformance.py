...
def get_model_list():
    ...
    model_list = ["mobilenetv2_050", "resnet18", "mobilenetv3_large_075", "xception", "resnet18","seresnet18", "vgg11", "repvgg_a2","efficientnet_b0","efficientnet_el_pruned","efficientnet_lite0", "efficientnetv2_l"]

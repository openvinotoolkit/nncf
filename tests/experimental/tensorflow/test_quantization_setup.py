...
from nncf.experimental.tensorflow.quantization.algorithm import QuantizationBuilderV2
...
def test_quantization_setup():
    ...
    builder = QuantizationBuilderV2(config, should_init=False)
    quantization_setup = builder._get_quantizer_setup(nncf_network)  # pylint:disable=protected-access

...
GROUP_PRUNING_MODULES_TEST_CASES = [
    GroupPruningModulesTestStruct(model=PruningTestModelEltwise,
                                  not_pruned_modules=['1 PruningTestModelEltwise/NNCFConv2d[conv1]/conv2d',
                                                      '7 PruningTestModelEltwise/NNCFConv2d[conv4]/conv2d'],
                                  pruned_groups=[['3 PruningTestModelEltwise/NNCFConv2d[conv2]/conv2d',
                                                  '4 PruningTestModelEltwise/NNCFConv2d[conv3]/conv2d']],
                                  pruned_groups_by_node_id=[[3, 4]],
                                  prune_params=(False, False, False)),
    GroupPruningModulesTestStruct(model=PruningTestModelEltwise,
                                  not_pruned_modules=[],
                                  pruned_groups=[['1 PruningTestModelEltwise/NNCFConv2d[conv1]/conv2d'],
                                                 ['7 PruningTestModelEltwise/NNCFConv2d[conv4]/conv2d'],
                                                 ['3 PruningTestModelEltwise/NNCFConv2d[conv2]/conv2d',
                                                  '4 PruningTestModelEltwise/NNCFConv2d[conv3]/conv2d']],
                                  pruned_groups_by_node_id=[[1], [7], [3, 4]],
                                  prune_params=(True, True, False)),
    GroupPruningModulesTestStruct(model=TestModelBranching,
                                  not_pruned_modules=[],
                                  pruned_groups=[['1 TestModelBranching/NNCFConv2d[conv1]/conv2d',
                                                  '2 TestModelBranching/NNCFConv2d[conv2]/conv2d',
                                                  '4 TestModelBranching/NNCFConv2d[conv3]/conv2d']],
                                  pruned_groups_by_node_id=[[1, 2, 4]],
                                  prune_params=(True, True, False)),
    GroupPruningModulesTestStruct(model=TestModelBranching,
                                  not_pruned_modules=['1 TestModelBranching/NNCFConv2d[conv1]/conv2d',
                                                      '2 TestModelBranching/NNCFConv2d[conv2]/conv2d',
                                                      '4 TestModelBranching/NNCFConv2d[conv3]/conv2d'],
                                  pruned_groups=[['7 TestModelBranching/NNCFConv2d[conv4]/conv2d',
                                                  '8 TestModelBranching/NNCFConv2d[conv5]/conv2d']],
                                  pruned_groups_by_node_id=[[7, 8]],
                                  prune_params=(False, True, False)),
    GroupPruningModulesTestStruct(model=TestModelBranching,
                                  not_pruned_modules=['7 TestModelBranching/NNCFConv2d[conv4]/conv2d',
                                                      '8 TestModelBranching/NNCFConv2d[conv5]/conv2d'],
                                  pruned_groups=[['1 TestModelBranching/NNCFConv2d[conv1]/conv2d',
                                                  '2 TestModelBranching/NNCFConv2d[conv2]/conv2d',
                                                  '4 TestModelBranching/NNCFConv2d[conv3]/conv2d']],
    ...
    GroupPruningModulesTestStruct(model=TestModelResidualConnection,
                                  not_pruned_modules=['6 TestModelResidualConnection/NNCFConv2d[conv4]/conv2d',
                                                      '8 TestModelResidualConnection/NNCFConv2d[conv5]/conv2d'],
                                  pruned_groups=[['1 TestModelResidualConnection/NNCFConv2d[conv1]/conv2d',
                                                  '2 TestModelResidualConnection/NNCFConv2d[conv2]/conv2d',
                                                  '4 TestModelResidualConnection/NNCFConv2d[conv3]/conv2d']],
                                  pruned_groups_by_node_id=[[1, 2, 4]],
                                  prune_params=(True, True, False),
    ...
    GroupPruningModulesTestStruct(model=TestModelEltwiseCombination,
                                  not_pruned_modules=[],
                                  pruned_groups=[['1 TestModelEltwiseCombination/NNCFConv2d[conv1]/conv2d',
                                                  '2 TestModelEltwiseCombination/NNCFConv2d[conv2]/conv2d',
                                                  '4 TestModelEltwiseCombination/NNCFConv2d[conv3]/conv2d',
                                                  '6 TestModelEltwiseCombination/NNCFConv2d[conv4]/conv2d'],
                                                 ['8 TestModelEltwiseCombination/NNCFConv2d[conv5]/conv2d',
                                                  '9 TestModelEltwiseCombination/NNCFConv2d[conv6]/conv2d']],
...
def test_groups(test_input_info_struct_: GroupPruningModulesTestStruct):
    ...
    for group in pruned_groups:
        ...
        group_module_names = [name.rsplit('/', 1)[0].split(' ', 1)[1] for name in group]
        group_modules = [compressed_model.get_module_by_scope(Scope.from_str(module_scope))
                         for module_scope in group_module_names]

...
def multiconf_quant_setup_for_unified_scale_testing() -> MultiConfigQuantizerSetup:
    ...
    setup.quantization_points = {
        0: MultiConfigQuantizationPoint(ActivationQuantizationInsertionPoint(target_node_name="A"),
                                        [QCONFIG_PER_CHANNEL, QCONFIG_PER_TENSOR],
                                        []),
        1: MultiConfigQuantizationPoint(ActivationQuantizationInsertionPoint(target_node_name="B"),
                                        [QCONFIG_PER_CHANNEL, QCONFIG_PER_TENSOR],
                                        []),
        2: MultiConfigQuantizationPoint(ActivationQuantizationInsertionPoint(target_node_name="C"),
                                        [QCONFIG_PER_CHANNEL, QCONFIG_PER_TENSOR],
                                        []),
        3: MultiConfigQuantizationPoint(ActivationQuantizationInsertionPoint(target_node_name="D"),
                                        [QCONFIG_PER_CHANNEL, QCONFIG_PER_TENSOR],
                                        [])
    }
    return setup
...
@pytest.mark.parametrize("test_struct", [
    UnifiedScaleAssignmentTestStruct(
        ...
        qconfig_choices={0: QCONFIG_PER_TENSOR, 1: QCONFIG_PER_TENSOR, 2: QCONFIG_PER_TENSOR, 3: QCONFIG_PER_TENSOR},
        ref_unified_groups_after_qconfig_selection=[{0, 1}]),
    UnifiedScaleAssignmentTestStruct(
        unified_groups=[{1, 2, 3}],
        unification_types={1: UnifiedScaleType.UNIFY_ALWAYS, 2: UnifiedScaleType.UNIFY_ALWAYS, 3: UnifiedScaleType.UNIFY_ALWAYS},
        qconfig_choices={0: QCONFIG_PER_TENSOR, 1: QCONFIG_PER_TENSOR, 2: QCONFIG_PER_TENSOR, 3: QCONFIG_PER_TENSOR},
        ref_unified_groups_after_qconfig_selection=[{1, 2, 3}]),
    UnifiedScaleAssignmentTestStruct(
        unified_groups=[{0, 1}],
        unification_types={0: UnifiedScaleType.UNIFY_ALWAYS, 1: UnifiedScaleType.UNIFY_ALWAYS},
        qconfig_choices={0: QCONFIG_PER_CHANNEL, 1: QCONFIG_PER_CHANNEL, 2: QCONFIG_PER_CHANNEL, 3: QCONFIG_PER_TENSOR},
        ref_unified_groups_after_qconfig_selection=[{0, 1}]),
    UnifiedScaleAssignmentTestStruct(
        unified_groups=[{0, 1}],
    ...
    UnifiedScaleAssignmentTestStruct(
        unified_groups=[{1, 2, 3}],
        unification_types={1: UnifiedScaleType.UNIFY_ONLY_PER_TENSOR, 2: UnifiedScaleType.UNIFY_ONLY_PER_TENSOR, 3: UnifiedScaleType.UNIFY_ONLY_PER_TENSOR},
        qconfig_choices={0: QCONFIG_PER_TENSOR, 1: QCONFIG_PER_CHANNEL, 2: QCONFIG_PER_TENSOR, 3: QCONFIG_PER_CHANNEL},
        ref_unified_groups_after_qconfig_selection=[]),
    UnifiedScaleAssignmentTestStruct(
        unified_groups=[{1, 2, 3}],
        unification_types={1: UnifiedScaleType.UNIFY_ONLY_PER_TENSOR, 2: UnifiedScaleType.UNIFY_ONLY_PER_TENSOR, 3: UnifiedScaleType.UNIFY_ONLY_PER_TENSOR},
        qconfig_choices={0: QCONFIG_PER_TENSOR, 1: QCONFIG_PER_TENSOR, 2: QCONFIG_PER_CHANNEL, 3: QCONFIG_PER_TENSOR},
        ref_unified_groups_after_qconfig_selection=[{1, 3}]),
    UnifiedScaleAssignmentTestStruct(
        unified_groups=[{0, 2}, {1, 3}],
        unification_types={0: UnifiedScaleType.UNIFY_ALWAYS, 1: UnifiedScaleType.UNIFY_ALWAYS, 2: UnifiedScaleType.UNIFY_ALWAYS, 3: UnifiedScaleType.UNIFY_ALWAYS},
        qconfig_choices={0: QCONFIG_PER_TENSOR, 1: QCONFIG_PER_CHANNEL, 2: QCONFIG_PER_TENSOR, 3: QCONFIG_PER_CHANNEL},
...
def test_unified_scale_assignment_based_on_qconfig_selection(test_struct: UnifiedScaleAssignmentTestStruct,
    ...
    for us_group in test_struct.unified_groups:
        ...
        multi_setup.register_unified_scale_group_with_types(us_group_list,
                                                      [test_struct.unification_types[qp_id] for qp_id in us_group_list])

...
from nncf.common.quantization.quantizer_removing import find_fq_nodes_to_cut
...
GRAPHS = {
    'simple_graph': Graph(
        [
            Node(0, "parameter"), Node(116, "relu"), Node(117, "add"),
            Node(118, "max_pool2d"), Node(119, "quantizer"), Node(124, "relu"),
            Node(125, "add"), Node(126, "constant"), Node(127, "conv2d"),
            Node(128, "quantizer"), Node(133, "constant"), Node(134, "quantizer"),
            Node(139, "quantizer"), Node(144, "add"), Node(145, "constant"),
            Node(146,"conv2d"), Node(147, "quantizer"), Node(152, "constant"),
            Node(153, "quantizer"), Node(158, "relu"), Node(159, "add"),
            Node(160, "constant"), Node(161, "conv2d"), Node(162, "quantizer"),
            Node(167, "constant"),
        ],
        [
            Edge(117, 0, 116, 0), Edge(118, 0, 117, 1), Edge(139, 0, 117, 0), Edge(119, 0, 118, 0),
            Edge(124, 0, 119, 0), Edge(125, 0, 124, 0), Edge(126, 0, 125, 1), Edge(127, 0, 125, 0),
            Edge(128, 0, 127, 1), Edge(134, 0, 127, 0), Edge(133, 0, 128, 0), Edge(0, 0, 134, 0),
            Edge(144, 0, 139, 0), Edge(145, 0, 144, 1), Edge(146, 0, 144, 0), Edge(147, 0, 146, 1),
            Edge(153, 0, 146, 0), Edge(152, 0, 147, 0), Edge(158, 0, 153, 0), Edge(159, 0, 158, 0),
            Edge(160, 0, 159, 1), Edge(161, 0, 159, 0), Edge(118, 0, 161, 0), Edge(162, 0, 161, 1),
            Edge(167, 0, 162, 0),
        ]
    ),
}
...
def create_nncf_graph(graph: Graph) -> NNCFGraph:
    ...
    for e in graph.edges:
        nncf_graph.add_edge_between_nncf_nodes(
            correspondences[e.from_node_id],
            correspondences[e.to_node_id],
            [],
            e.to_port,
            e.from_port,
            Dtype.FLOAT
...
def test_find_fq_nodes_to_cut(nncf_graph: NNCFGraph, test_case: TestCase):

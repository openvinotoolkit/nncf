...
class TestPattern:
    ...
    common_nodes = {
        '1': {GraphPattern.METATYPE_ATTR: 'a'}, '2': {GraphPattern.METATYPE_ATTR: 'b'},
        '3': {GraphPattern.METATYPE_ATTR: 'c'},
        '4': {GraphPattern.METATYPE_ATTR: 'a'}, '5': {GraphPattern.METATYPE_ATTR: 'e'},
        '6': {GraphPattern.METATYPE_ATTR: 'a'}
    }
    non_pattern_nodes = {'7': {GraphPattern.METATYPE_ATTR: GraphPattern.NON_PATTERN_NODE_TYPE},
    ...
    any_pattern_nodes = {'7': {GraphPattern.METATYPE_ATTR: GraphPattern.ANY_PATTERN_NODE_TYPE},

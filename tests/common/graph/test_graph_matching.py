...
def create_graph_with_many_nodes():
    ...
    nodes = {
        ...
        '3': {GraphPattern.METATYPE_ATTR: 'c'}, '4': {GraphPattern.METATYPE_ATTR: 'a'},
        '5': {GraphPattern.METATYPE_ATTR: 'e'},
        '6': {GraphPattern.METATYPE_ATTR: 'a'}, '7': {GraphPattern.METATYPE_ATTR: 'a'},
        '8': {GraphPattern.METATYPE_ATTR: 'b'}, '9': {GraphPattern.METATYPE_ATTR: 'c'}
    }

...
def test_reference_quantization_on_cpu_isolated(mocker):
    ...
    from tests.torch2.quantization.test_functions import check_outputs_for_quantization_functions
    from tests.torch2.quantization.test_functions import generate_input

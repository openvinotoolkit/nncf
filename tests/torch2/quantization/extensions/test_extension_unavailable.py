...
from tests.torch2.quantization.extensions.isolated_cases import (
...
from tests.torch2.quantization.extensions.isolated_cases import test_reference_quantization_on_cpu_isolated

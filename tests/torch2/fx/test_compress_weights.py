...
from tests.torch2.function_hook.quantization.test_weights_compression import TestPTTemplateWeightCompression
...
class TestFXTemplateWeightCompression(TemplateWeightCompression):
    ...
    def get_scale_estimation_ref(check_sampling_activation_stats_flow):
        return TestPTTemplateWeightCompression.get_scale_estimation_ref(check_sampling_activation_stats_flow)

    @staticmethod
    def get_moe_scale_estimation_ref(check_sampling_activation_stats_flow):
        return TestPTTemplateWeightCompression.get_moe_scale_estimation_ref(check_sampling_activation_stats_flow)

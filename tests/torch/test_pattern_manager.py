...
IGNORED_PATTERN_REASONS = {
    ...
    PatternNames.ARITHMETIC_ACTIVATIONS: 'Not relevant for Torch.',
    PatternNames.ARITHMETIC_ACTIVATIONS_BATCH_NORM: 'Not relevant for Torch.',
    PatternNames.ARITHMETIC_ACTIVATIONS_SCALE_SHIFT: 'Not relevant for Torch.',
    PatternNames.ARITHMETIC_BATCH_NORM: 'Not relevant for Torch.',
    PatternNames.ARITHMETIC_BATCH_NORM_ACTIVATIONS: 'Not relevant for Torch.',
    ...
    PatternNames.LINEAR_ACTIVATIONS: 'Not relevant for Torch.',
    PatternNames.LINEAR_ACTIVATIONS_BATCH_NORM: 'Not relevant for Torch.',
    ...
    PatternNames.LINEAR_BATCH_NORM: 'Not relevant for Torch.',
    PatternNames.LINEAR_BATCH_NORM_ACTIVATIONS: 'Not relevant for Torch.',

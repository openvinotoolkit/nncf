...
REF_BUILDING_BLOCKS_FOR_RESNET = [
    ...
    BuildingBlock('ResNet/Sequential[layer4]/Bottleneck[1]/relu_2', 'ResNet/Sequential[layer4]/Bottleneck[2]/relu_2')]  # 12

REF_BUILDING_BLOCKS_FOR_MOBILENETV2 = [
    BuildingBlock('MobileNetV2/Sequential[features]/InvertedResidual[2]/Sequential[conv]/NNCFBatchNorm[3]/batch_norm_0',
     'MobileNetV2/Sequential[features]/InvertedResidual[3]/__add___0'),
    BuildingBlock('MobileNetV2/Sequential[features]/InvertedResidual[4]/Sequential[conv]/NNCFBatchNorm[3]/batch_norm_0',
    ...
    BuildingBlock('MobileNetV2/Sequential[features]/InvertedResidual[11]/Sequential[conv]/NNCFBatchNorm[3]/batch_norm_0',
     'MobileNetV2/Sequential[features]/InvertedResidual[12]/__add___0'),
    BuildingBlock('MobileNetV2/Sequential[features]/InvertedResidual[12]/__add___0',
     'MobileNetV2/Sequential[features]/InvertedResidual[13]/__add___0'),
    BuildingBlock('MobileNetV2/Sequential[features]/InvertedResidual[14]/Sequential[conv]/NNCFBatchNorm[3]/batch_norm_0',
...
@pytest.mark.parametrize('algo_params',  (
    ...
    SearchBBlockAlgoParamsCase(max_block_size=7,
                               ref_blocks=[BuildingBlock("ResNet/MaxPool2d[maxpool]/max_pool2d_0", "ResNet/Sequential[layer1]/BasicBlock[0]/relu_1")]),
    SearchBBlockAlgoParamsCase(max_block_size=8,
                               ref_blocks=[BuildingBlock("ResNet/MaxPool2d[maxpool]/max_pool2d_0", "ResNet/Sequential[layer1]/BasicBlock[0]/relu_1"),
                                           BuildingBlock("ResNet/Sequential[layer1]/BasicBlock[0]/relu_1", "ResNet/Sequential[layer1]/BasicBlock[1]/relu_1"),
                                           BuildingBlock("ResNet/Sequential[layer2]/BasicBlock[0]/relu_1", "ResNet/Sequential[layer2]/BasicBlock[1]/relu_1"),
                                           BuildingBlock("ResNet/Sequential[layer3]/BasicBlock[0]/relu_1", "ResNet/Sequential[layer3]/BasicBlock[1]/relu_1"),
                                           BuildingBlock("ResNet/Sequential[layer4]/BasicBlock[0]/relu_1", "ResNet/Sequential[layer4]/BasicBlock[1]/relu_1")
                               ]),
    SearchBBlockAlgoParamsCase(min_block_size=10,
                               max_block_size=20,
                               ref_blocks=[BuildingBlock("ResNet/MaxPool2d[maxpool]/max_pool2d_0", "ResNet/Sequential[layer1]/BasicBlock[1]/relu_1")]),
    SearchBBlockAlgoParamsCase(max_block_size=20,
                               allow_nested_blocks=True,
                               ref_blocks=[# start nested block group
                                           BuildingBlock("ResNet/MaxPool2d[maxpool]/max_pool2d_0", "ResNet/Sequential[layer1]/BasicBlock[0]/relu_1"), # block A
                                           BuildingBlock("ResNet/Sequential[layer1]/BasicBlock[0]/relu_1", "ResNet/Sequential[layer1]/BasicBlock[1]/relu_1"), # block B
                                           BuildingBlock("ResNet/MaxPool2d[maxpool]/max_pool2d_0", "ResNet/Sequential[layer1]/BasicBlock[1]/relu_1"), # block C
    ...
    SearchBBlockAlgoParamsCase(max_block_size=20,
                               ...
                               ref_blocks=[# nested block group is empty because parameter allow_linear_combination is false and the biggest block was deleted.
                                           BuildingBlock("ResNet/MaxPool2d[maxpool]/max_pool2d_0", "ResNet/Sequential[layer1]/BasicBlock[0]/relu_1"),
                                           BuildingBlock("ResNet/Sequential[layer1]/BasicBlock[0]/relu_1", "ResNet/Sequential[layer1]/BasicBlock[1]/relu_1"),
                                           BuildingBlock("ResNet/Sequential[layer2]/BasicBlock[0]/relu_1", "ResNet/Sequential[layer2]/BasicBlock[1]/relu_1"),
                                           BuildingBlock("ResNet/Sequential[layer3]/BasicBlock[0]/relu_1", "ResNet/Sequential[layer3]/BasicBlock[1]/relu_1"),
                                           BuildingBlock("ResNet/Sequential[layer4]/BasicBlock[0]/relu_1", "ResNet/Sequential[layer4]/BasicBlock[1]/relu_1")]))

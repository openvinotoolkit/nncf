...
LIST_WSS_PARAMS = [
    ...
    WidthSearchSpaceParams(64, {'width_multipliers': [0.25, 0.5, 0.125], 'min_out_channels': 8}, [64, 32, 16, 8]),
    WidthSearchSpaceParams(64, {'width_multipliers': [0, 1, 0.25, 0.5, 0.125], 'min_out_channels': 8},
                           [64, 32, 16, 8]),
    WidthSearchSpaceParams(64, {'width_multipliers': [0, 1, 0.25, 0.5, 0.125], 'min_out_channels': 8},
                           [64, 32, 16, 8]),
    WidthSearchSpaceParams(32, {'min_out_channels': 16}, [32]),
    WidthSearchSpaceParams(32, {'min_out_channels': 16, 'width_step': 16}, [32, 16]),
    WidthSearchSpaceParams(64, {'width_step': 16, 'max_num_widths': 3}, [64, 48, 32]),
    WidthSearchSpaceParams(64, {'min_out_channels': 64}, [64]),

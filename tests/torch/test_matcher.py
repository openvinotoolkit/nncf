...
# def test_graph_pattern_matching():
#     g = nx.DiGraph()
#     node_key_0 = '0'
#     node_attrs_0 = {'type': 'conv2d'}
#     g.add_node(node_key_0, **node_attrs_0)
#     node_key_1 = '1'
#     node_attrs_1 = {'type': 'relu'}
#     g.add_node(node_key_1, **node_attrs_1)
#     node_key_2 = '2'
#     node_attrs_2 = {'type': 'BatchNorm'}
#     g.add_node(node_key_2, **node_attrs_2)
#     g.add_edge(node_key_0, node_key_1)
#     g.add_edge(node_key_1, node_key_2)
#
#     j = nx.DiGraph()
#     node_key_0 = '3'
#     node_attrs_0 = {'type': 'conv2d'}
#     j.add_node(node_key_0, **node_attrs_0)
#     node_key_1 = '4'
#     node_attrs_1 = {'type': 'relu'}
#     j.add_node(node_key_1, **node_attrs_1)
#     j.add_edge(node_key_0, node_key_1)
#
#     def are_nodes_matching(node_1, node_2):
#         return node_1['type'] == node_2['type']
#
#     matcher = ism.DiGraphMatcher(g, j, node_match=are_nodes_matching)
#

...
def main(argv):
    ...
    parser.add_argument('--model-name', help='Model name specified in IS_TO_BUILED_MAP map',
                        required=True)
    parser.add_argument('--xml-path', help='Path to input IR xml file',
                        required=True)
    parser.add_argument('--bin-path', help='Path to input IR bin file',
                        required=True)

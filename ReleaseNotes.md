...
- Fixes:
  ...
  - Fixed wrong usage of `do_float_quantization` in Weight Compression https://github.com/openvinotoolkit/nncf/pull/3991).
- Improvements:
  ...
  - Removed redundant `get_raw_statistic_collector` backend methods across backends https://github.com/openvinotoolkit/nncf/pull/3979).
- Tutorials:

...
def get_ignored_names_by_ignored_patterns(inference_nncf_graph: NNCFGraph, ignored_patterns: GraphPattern) -> set[str]:
    """
    ...
    :return: NNCF node names which correspond to all node names matched ignored_patterns.
    """
    nncf_node_names = set()

...
class TFCompositeCompressionAlgorithmBuilder(
    ...
    def _build_controller(self, model: T_model) -> CompositeCompressionAlgorithmController:
    ...
    def get_transformation_layout(self, model: T_model) -> TFTransformationLayout:

...
elif not (tensorflow_version_major == 2 and 4 <= tensorflow_version_minor <= 12):
    raise RuntimeError(
        f"NNCF only supports 2.4.0 <= tensorflow <= 2.12.*, while current tensorflow version is {_tf_version}"
    )

...
class TrainingRunner(ABC):
    ...
    @abstractmethod
    def train_epoch(self, model: T_model, compression_controller: CompressionAlgorithmController) -> None:
        """
    ...
    @abstractmethod
    def validate(self, model: T_model) -> float:
        """
    ...
    @abstractmethod
    def dump_statistics(self, model: T_model, compression_controller: CompressionAlgorithmController) -> None:
        """
    ...
    @abstractmethod
    def dump_checkpoint(self, model: T_model, compression_controller: CompressionAlgorithmController) -> None:
        """
    ...
    @abstractmethod
    def retrieve_uncompressed_model_accuracy(self, model: T_model) -> None:
        """
    ...
    @abstractmethod
    def initialize_training_loop_fns(self, train_epoch_fn: Callable[[CompressionAlgorithmController, T_model,
                                                                     Optional[OptimizerType],
                                                                     Optional[LRSchedulerType],
                                                                     Optional[int]], None],
                                     validate_fn: Callable[[T_model, Optional[float]], float],
                                     configure_optimizers_fn: Callable[[], Tuple[OptimizerType, LRSchedulerType]],
                                     dump_checkpoint_fn: Callable[
                                         [T_model, CompressionAlgorithmController, 'TrainingRunner', str], None],
    ...
    @abstractmethod
    def load_best_checkpoint(self, model: T_model) -> None:
        """

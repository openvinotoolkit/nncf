...
from nncf.experimental.post_training.algorithms.quantization.algorithm import DefaultQuantization
from nncf.experimental.post_training.algorithms.quantization.algorithm import DefaultQuantizationParameters

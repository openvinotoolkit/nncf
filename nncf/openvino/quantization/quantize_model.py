...
from nncf.openvino.quantization.quanitze_if_model import dfs_apply_algorithm
...
def native_quantize_if_op_impl(
    ...
    quantized_model, _ = dfs_apply_algorithm(quantization_algorithm, model, graph, calibration_dataset, None, 0)

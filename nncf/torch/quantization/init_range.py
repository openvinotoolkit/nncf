...
from nncf.common.quantization.structs import NonWeightQuantizerId, QuantizerScaleShape
...
from nncf.experimental.common.tensor_statistics.collectors import AggregationAxes, TensorCollector

...
LINEAR_OPERATIONS = {GraphPattern.METATYPE_ATTR: ['linear',
                                                  'conv1d',
                                                  'conv2d',
                                                  'conv3d',
                                                  'conv_transpose1d',
...
BATCH_NORMALIZATION_OPERATIONS = {GraphPattern.METATYPE_ATTR: ['batch_norm',
                                                               'batch_norm1d',
                                                               'batch_norm2d',
                                                               'batch_norm3d'
                                                               ],
...
GROUP_NORMALIZATION_OPERATIONS = {GraphPattern.METATYPE_ATTR: ['group_norm'],
                                  GraphPattern.LABEL_ATTR: 'GROUP_NORMALIZATION'}

LAYER_NORMALIZATION_OPERATIONS = {GraphPattern.METATYPE_ATTR: ['layer_norm'],
                                  GraphPattern.LABEL_ATTR: 'LAYER_NORMALIZATION'}

RELU_OPERATIONS = {GraphPattern.METATYPE_ATTR: ['relu',
                                                'relu_',
                                                'hardtanh'
                                               ],
...
NON_RELU_ACTIVATIONS_OPERATIONS = {GraphPattern.METATYPE_ATTR: ['elu',
                                                                'elu_',
                                                                'prelu',
                                                                'leaky_relu',
                                                                'sigmoid',
...
ARITHMETIC_OPERATIONS = {GraphPattern.METATYPE_ATTR: ['__iadd__',
                                                      '__add__',
                                                      '__mul__',
                                                      '__rmul__',
                                                      '__truediv__'],
...
POOLING_OPERATIONS = {GraphPattern.METATYPE_ATTR: ['adaptive_avg_pool2d',
                                                   'adaptive_avg_pool3d',
                                                   'avg_pool2d',
                                                   'avg_pool3d'],

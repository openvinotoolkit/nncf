...
def get_operator_metatypes() -> List[Type[OperatorMetatype]]:
    ...
    """
    return list(PT_OPERATOR_METATYPES.registry_dict.values()) + list(FX_OPERATOR_METATYPES.registry_dict.values()) + list(PT2_OPERATOR_METATYPES.registry_dict.values())

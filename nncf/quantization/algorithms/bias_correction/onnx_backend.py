...
from nncf.common.tensor_statistics.collectors import ReductionShape, MeanStatisticCollector, RawStatisticCollector
...
from nncf.onnx.tensor import ONNXNNCFTensorBackend

...
class OVBiasCorrectionAlgoBackend(BiasCorrectionAlgoBackend):
    ...
    def bias_correction_command(target_point: OVTargetPoint,
                                bias_value: np.ndarray) -> OVBiasCorrectionCommand:
    ...
    def get_input_output_names(node: NNCFNode, nncf_graph: NNCFGraph) -> Tuple[str, str]:
        ...
        bias_node = OVBiasCorrectionAlgoBackend.get_bias_node(node, nncf_graph)
    ...
    @staticmethod
    def get_output_names(model: ov.Model, node_name: str) -> List[str]:
    ...
    def is_node_with_bias(biased_node: NNCFNode, nncf_graph: NNCFGraph) -> bool:
        bias_node = OVBiasCorrectionAlgoBackend.get_bias_node(biased_node, nncf_graph)

...
class MinMaxQuantization(Algorithm):
    ...
    def _get_ignored_names(
        ...
        elemetwise_with_const = self._backend_entity.find_elementwise_with_constants(nncf_graph, inference_nncf_graph)

        ignored_names.update({name: IgnoreReason.USER_REQUESTED for name in elemetwise_with_const})
        ...
        # USER_REQUESTED -> AUTOGENERATED to test whether new elementwise ops were ignored
        ignored_names.update({name: IgnoreReason.AUTOGENERATED for name in user_ignored_names})

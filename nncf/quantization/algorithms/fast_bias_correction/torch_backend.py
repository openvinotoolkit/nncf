...
from nncf.common.tensor_statistics.collectors import ReductionShape, MeanStatisticCollector
...
class PTFastBiasCorrectionAlgoBackend(FastBiasCorrectionAlgoBackend):
    ...
    @staticmethod
    def get_bias_value(node: NNCFNode, nncf_graph: NNCFGraph, model: NNCFNetwork) -> PTNNCFTensor:
        return PTNNCFTensor(get_fused_bias_value(node, model))

...
class StatisticsCollectorParameters:
    ...
    :param quantile_outlier_prob: The outlier probability for QUANTILE statistic or MEAN_NO_OUTLIERS aggregator.
        When using these together, please be aware that currently the quantile value will be applied to both.

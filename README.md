...
The NNCF PTQ is the simplest way to apply 8-bit quantization. To run the algorithm you only need your model and a calibration dataset with 100-500 no-label samples. The basic workflow steps:

...
class WeightCompression(Algorithm):
    ...
    def get_ignored_node_names(self, nncf_graph: NNCFGraph) -> set[str]:
        ...
        ignored_names = propagate_ignored_constants_to_weighted_consumers(
            ...
            constant_metatypes=self._backend_entity.constant_metatypes,
            passthrough_metatypes=self._backend_entity.passthrough_metatypes,
            passthrough_node_types=self._backend_entity.passthrough_node_types,
        )
    ...
    def _get_ignored_scope_weight_statistics(self, model: TModel, graph: NNCFGraph) -> list[int]:
        ...
        ignored_names = propagate_ignored_constants_to_weighted_consumers(
            ignored_names,
            graph,
            weighted_metatypes=weighted_metatypes,
            constant_metatypes=self._backend_entity.constant_metatypes,
            passthrough_metatypes=self._backend_entity.passthrough_metatypes,
            passthrough_node_types=self._backend_entity.passthrough_node_types,
        )

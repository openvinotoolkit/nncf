...
![output = \frac{\left\lfloor (clamp(input; input\_low, input\_high)-input\_low)  *s\right \rceil}{s} + input\_low\\](https://microsoft.codecogs.com/png.latex?output%20%3D%20%5Cfrac%7B%5Cleft%5Clfloor%20%28clamp%28input%3B%20input%5C_low%2C%20input%5C_high%29-input%5C_low%29%20*s%5Cright%20%5Crceil%7D%7Bs%7D%20&plus;%20input%5C_low%5C%5C)

![clamp(input; input\_low, input\_high) = min(max(input, input\_low), input\_high)))](https://microsoft.codecogs.com/png.latex?clamp%28input%3B%20input%5C_low%2C%20input%5C_high%29%20%3D%20min%28max%28input%2C%20input%5C_low%29%2C%20input%5C_high%29%29%29)

![s=\frac{levels-1}{input\_high - input\_low}](https://microsoft.codecogs.com/png.latex?s%3D%5Cfrac%7Blevels-1%7D%7Binput%5C_high%20-%20input%5C_low%7D)

`input_low` and `input_high` represent the quantization range and ![\left\lfloor\cdot\right \rceil](https://microsoft.codecogs.com/png.latex?%5Cleft%5Clfloor%5Ccdot%5Cright%20%5Crceil) denotes rounding to the nearest integer.
...
![input\_low=scale*\frac{level\_low}{level\_high}](https://microsoft.codecogs.com/png.latex?input%5C_low%3Dscale*%5Cfrac%7Blevel%5C_low%7D%7Blevel%5C_high%7D)

![input\_high=scale](https://microsoft.codecogs.com/png.latex?input%5C_high%3Dscale)
...
In the formula above, `level_low` and `level_high` represent the range of the discrete signal.
 - For weights:
    ...
    ![levels=255](https://microsoft.codecogs.com/png.latex?levels%3D255)
 ...
 - For unsigned activations:
    ...
    ![levels=256](https://microsoft.codecogs.com/png.latex?levels%3D256)
...
![output = \left\lfloor clamp(input * \frac{level\_high}{scale}, level\_low, level\_high)\right \rceil * \frac{scale}{level\_high}](https://microsoft.codecogs.com/png.latex?output%20%3D%20%5Cleft%5Clfloor%20clamp%28input%20*%20%5Cfrac%7Blevel%5C_high%7D%7Bscale%7D%2C%20level%5C_low%2C%20level%5C_high%29%5Cright%20%5Crceil%20*%20%5Cfrac%7Bscale%7D%7Blevel%5C_high%7D)
...
![input\_high=input\_low + input\_range](https://microsoft.codecogs.com/png.latex?input%5C_high%3Dinput%5C_low%20&plus;%20input%5C_range)
...
![{input\_low}' = min(input\_low, 0)](https://microsoft.codecogs.com/png.latex?%7Binput%5C_low%7D%27%20%3D%20min%28input%5C_low%2C%200%29)

![{input\_high}' = max(input\_high, 0)](https://microsoft.codecogs.com/png.latex?%7Binput%5C_high%7D%27%20%3D%20max%28input%5C_high%2C%200%29)

![ZP= \left\lfloor \frac{-{input\_low}'*(levels-1)}{{input\_high}'-{input\_low}'} \right \rceil ](https://microsoft.codecogs.com/png.latex?ZP%3D%20%5Cleft%5Clfloor%20%5Cfrac%7B-%7Binput%5C_low%7D%27*%28levels-1%29%7D%7B%7Binput%5C_high%7D%27-%7Binput%5C_low%7D%27%7D%20%5Cright%20%5Crceil)

![{input\_high}''=\frac{ZP-levels+1}{ZP}*{input\_low}'](https://microsoft.codecogs.com/png.latex?%7Binput%5C_high%7D%27%27%3D%5Cfrac%7BZP-levels+1%7D%7BZP%7D*%7Binput%5C_low%7D%27)

![{input\_low}''=\frac{ZP}{ZP-levels+1}*{input\_high}'](https://microsoft.codecogs.com/png.latex?%7Binput%5C_low%7D%27%27%3D%5Cfrac%7BZP%7D%7BZP-levels+1%7D*%7Binput%5C_high%7D%27)

![{input\_low,input\_high} = \begin{cases} {input\_low}',{input\_high}', & ZP \in $\{0,levels-1\}$ \\ {input\_low}',{input\_high}'', & {input\_high}'' - {input\_low}' > {input\_high}' - {input\_low}'' \\ {input\_low}'',{input\_high}', & {input\_high}'' - {input\_low}' <= {input\_high}' - {input\_low}''\\ \end{cases}](https://microsoft.codecogs.com/png.latex?%7Binput%5C_low%2Cinput%5C_high%7D%20%3D%20%5Cbegin%7Bcases%7D%20%7Binput%5C_low%7D%27%2C%7Binput%5C_high%7D%27%2C%20%26%20ZP%20%5Cin%20%24%5C%7B0%2Clevels-1%5C%7D%24%20%5C%5C%20%7Binput%5C_low%7D%27%2C%7Binput%5C_high%7D%27%27%2C%20%26%20%7Binput%5C_high%7D%27%27%20-%20%7Binput%5C_low%7D%27%20%3E%20%7Binput%5C_high%7D%27%20-%20%7Binput%5C_low%7D%27%27%20%5C%5C%20%7Binput%5C_low%7D%27%27%2C%7Binput%5C_high%7D%27%2C%20%26%20%7Binput%5C_high%7D%27%27%20-%20%7Binput%5C_low%7D%27%20%3C%3D%20%7Binput%5C_high%7D%27%20-%20%7Binput%5C_low%7D%27%27%5C%5C%20%5Cend%7Bcases%7D)
...
![output = \frac{\left\lfloor clamp(input-input\_low^{*}, level\_low, level\_high)*s\right \rceil} {s} + input\_low^{*}](https://microsoft.codecogs.com/png.latex?output%20%3D%20%5Cfrac%7B%5Cleft%5Clfloor%20clamp%28input-input%5C_low%5E%7B*%7D%2C%20level%5C_low%2C%20level%5C_high%29*s%5Cright%20%5Crceil%7D%20%7Bs%7D%20&plus;%20input%5C_low%5E%7B*%7D)

![s = \frac{level\_high}{|input\_range^{*}| + eps}](https://microsoft.codecogs.com/png.latex?s%20%3D%20%5Cfrac%7Blevel%5C_high%7D%7B%7Cinput%5C_range%5E%7B*%7D%7C%20&plus;%20eps%7D)

For asymmetric:
![\\input\_low^{*} = input\_low \\ input\_range^{*} = input\_range ](https://microsoft.codecogs.com/png.latex?%5C%5Cinput%5C_low%5E%7B*%7D%20%3D%20input%5C_low%20%5C%5C%20input%5C_range%5E%7B*%7D%20%3D%20input%5C_range)

For symmetric:
![\\input\_low^{*} = 0 \\ input\_range^{*} = scale](https://microsoft.codecogs.com/png.latex?%5C%5Cinput%5C_low%5E%7B*%7D%20%3D%200%20%5C%5C%20input%5C_range%5E%7B*%7D%20%3D%20scale)
...
![\overline{Tr}(H_{i}) * \left \| Q(W_{i}) - W_{i} \right \|^2_2](https://microsoft.codecogs.com/png.latex?%5Coverline%7BTr%7D%28H_%7Bi%7D%29%20*%20%5Cleft%20%5C%7C%20Q%28W_%7Bi%7D%29%20-%20W_%7Bi%7D%20%5Cright%20%5C%7C%5E2_2)
...
![Tr(H) = \mathbb{E}[v^T H v]](https://microsoft.codecogs.com/png.latex?Tr%28H%29%20%3D%20%5Cmathbb%7BE%7D%5Bv%5ET%20H%20v%5D)
...
![Tr(H) \approx \frac{1}{m}\sum_{i=1}^{m}[v_i^T H v_i]](https://microsoft.codecogs.com/png.latex?Tr%28H%29%20%5Capprox%20%5Cfrac%7B1%7D%7Bm%7D%5Csum_%7Bi%3D1%7D%5E%7Bm%7D%5Bv_i%5ET%20H%20v_i%5D)

Evaluation of the quadratic term happens by computing ![Hv](https://microsoft.codecogs.com/png.latex?Hv) - the result
...
For gradient of the loss with respect to the i-th block ![g_i](https://microsoft.codecogs.com/png.latex?g_i) and for
a random vector v, which is independent of ![W_i](https://microsoft.codecogs.com/png.latex?W_i), we have the equation:

![\frac{\partial(g_i^T v)}{\partial  W_i} = H_i v](https://microsoft.codecogs.com/png.latex?%5Cfrac%7B%5Cpartial%28g_i%5ET%20v%29%7D%7B%5Cpartial%20W_i%7D%20%3D%20H_i%20v)

where ![H_i](https://microsoft.codecogs.com/png.latex?H_i) is the Hessian matrix of loss with respect to
![W_i](https://microsoft.codecogs.com/png.latex?W_i). Hence ![Hv](https://microsoft.codecogs.com/png.latex?Hv) can be

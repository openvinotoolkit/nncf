...
|-----------|------------|----------|----------|------------|--------|
| `develop` | `2025.1.0` | `2.7.0`  | `1.21.1` | `2.15.1`   | `3.10` |
...
This repository is tested on Python* 3.10.14, PyTorch* 2.7.0 (NVidia CUDA\* Toolkit 12.4) and TensorFlow* 2.15.1 (NVidia CUDA\* Toolkit 11.8).

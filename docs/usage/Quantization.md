...
$$
\frac{\partial \mathcal{L}}{\partial \mathrm{input\\_range}} = \begin{cases}
\dfrac{\partial \mathcal{L}}{\partial FQ} \cdot \dfrac{FQ(x) - x}{\mathrm{input\\_range}} & \text{in range} \\
\dfrac{\partial \mathcal{L}}{\partial FQ} & \text{above range} \\
\dfrac{\partial \mathcal{L}}{\partial FQ} \cdot \dfrac{\mathrm{level\\_low}}{\mathrm{level\\_high}} & \text{below range}
\end{cases}
$$
...
= \frac{FQ(x) - x}{\mathrm{input\\_range}}
$$
...
$$
\frac{\partial \mathcal{L}}{\partial \mathrm{input\\_low}} = \begin{cases}
0 & \text{in range} \\
